...
class PersonalSignup extends Component {
    ...
    emailDomainSelector = (e) => {
        let email_domain = ReactDOM.findDOMNode(this.refs.email_domain)
    ...
    checkEmail = () => {
        ...
        var email_domain = ReactDOM.findDOMNode(this.refs.email_domain).value.trim()
        var email = ''
        var email1 = ReactDOM.findDOMNode(this.refs.email).value.trim()
        if (email_domain !== '') email = email1 + '@' + email_domain
        else email = ReactDOM.findDOMNode(this.refs.email).value
        const params = {
            'email': email
        }
    ...
    render () {
        ...
        return (
            <div className="personal_wrap">
                {/* <div className="wrap_signup_type" >
                    <div className="signup_naver">
                    </div>
                ...
                <div className="signup_personal_basic">
                    <span>기본정보</span>
                </div>
                <div className="wrap_signup_personal_id">
                    <span>아이디(이메일)*</span> <span ref="email_true" className="personal_id_true">사용가능합니다.</span> <span ref="email_false" className="personal_id_false">이미 사용중인 이메일입니다.</span>
                </div>
                <div className="wrap_signup_personal_inputid">
                    <input placeholder="abcd1234" className="signup_personal_id" type="text" name="email" id="join_email" ref="email" onChange={this.checkEmail}></input>
                    <div className="wrap_signup_personal_at_section"><span>@</span></div>
                    <input placeholder="naver.com" className="signup_personal_id" type="text" name="email_domain" id="join_email_domain" ref="email_domain" onChange={this.checkEmail}
                           style={{ width: 147 }}></input>
                </div>
                <div style={{ margin: '0 auto', width: 437 }} className="join_email_domain_selector_wrap">
                    <div style={{ display: 'block', clear: 'both', textAlign: 'right' }}>
                        <select className="signup_personal_domain" name="email_domain_selector" id="join_email_domain_selector" ref="email_domain_selector" onChange={this.emailDomainSelector}>
                ...
                <div className="wrap_signup_personal_pw_section">
                    <input className="signup_personal_pw" type="password" name="password" id="join_password" onChange={this.pwcheck_step1}></input>
                </div>
                <div className="wrap_signup_personal_pw">
                ...
                <div className="wrap_signup_personal_pw_section">
                    <input className="signup_personal_pw" type="password" name="password_re" id="join_password_re" onChange={this.pwcheck_step2}></input>
                </div>
                <div className="wrap_signup_personal_pw">
                    <span>휴대폰 번호*</span>
                </div>
                <div className="wrap_signup_personal_inputphone">
                    <div className="wrap_signup_personal_phone_section">
                        <input placeholder="'_' 없이 입력" className="signup_personal_phone" type="text" name="phonenumber" id="join_phonenumber" ref="phonenumber"></input>
                    </div>
                    <div className="blank"></div>
                ...
                <div className="wrap_signup_personal_pw_section">
                    <input placeholder="홍길동" className="signup_personal_pw" id="join_name" type="text" name="name"></input>
                </div>
                <div className="wrap_signup_personal_pw">
                    <span>생년월일</span>
                </div>
                <div className="wrap_signup_personal_pw_section">
                    <input placeholder=" 년 월 일 여덟자리 (ex.19850423)" className="signup_personal_pw" type="text" id="join_birthdate" name="birthdate"></input>
                </div>
