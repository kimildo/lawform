...
class Inquiry extends Component {
    ...
    componentWillUpdate(nextProp) {
        if( !!nextProp.modalOpen && this.state.modalOpen !== nextProp.modalOpen ) {
            this.setState({
    ...
    handleSubmit = () =>{
        ...
        API.sendPost('/event/setdata', params ).then(result => {
            if( result.status === 'ok' ) {
                alert('등록되었습니다. ');
                this.setState({modalOpen:false, survey:surveyReset },this.props.onComplete);
            } else {
        ...
        return (
            <div className="survey">
                ...
                >
                    ...
                    {(!!this.props.title) ? this.props.title : `정기권 구매 문의`}
