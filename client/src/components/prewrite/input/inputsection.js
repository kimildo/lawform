...
class InputSection extends Component {
    ...
    render() {
            ...
            for (let j = 0; j < section.fields.length; j++) {
                ...
                // if (j+1 < section.fields.length) {
                    ...
                    if (section.fields[j].depth === '1' && section.fields[j-1].depth === '1' ) {
                        ...
                        inputFields.push(
                            <span // onClick={(this.props.loginCheckBeforePayment)}
                                onClick={(e) => this.props.sectionSelect(newUniqueKey)} 
                            >
        ...
        return (
            <div className="autoform_inputsection" onClick={(this.props.index > 1) && (this.props.showPaymentPop)}>
